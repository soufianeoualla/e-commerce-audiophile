const ShippingInfo = ({
  ...
  return (
    <div>
      ...
      <div className='flex items-center flex-wrap justify-between mt-4 mb-[53px] sm:flex-col sm:items-center sm:w-full  '>
        ...
        <label htmlFor='zip' className='w-[42%] md:w-[49%] my-6 sm:w-full'>
        <div className='flex  justify-between items-center'>
        ...
        <label htmlFor='city' className='w-[42%] md:w-[49%] my-6 sm:mt-0 sm:w-full' >
        <div className='flex  justify-between items-center'>
        ...
        <label htmlFor='country' className='w-[42%] md:w-[49%] sm:w-[100%]'>
        <div className='flex  justify-between items-center'>
